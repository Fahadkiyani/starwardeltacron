                                ...
                                <div className="card-body">
                                    <div>
                                        <div className='d-flex-row'>
                                            ...
                                            <p>{item?.gender === "male" ? <i class="fa fa-male" aria-hidden="true"></i> : (item?.gender === 'female' ? <i class="fa fa-female" aria-hidden="true"></i> : <i class="fa fa-genderless" aria-hidden="true"></i>)} {item?.gender}</p>
                                        </div>
                                        <p className="card-text pt-0 mt-0">
                                            <span className='text-muted'><i className="fa fa-eye"></i> {item?.eye_color} | {item?.height} inch | DOB {item?.birth_year}</span>
                                        </p>
